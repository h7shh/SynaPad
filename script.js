...
function showDetails(index) {
  ...
  document.getElementById('productName').innerHTML = `<span style="color: #db4646;">SynaPad</span> ${product.name.replace("SynaPad ", "")}`;
  if (product.name === "SynaPad Core") {
      document.getElementById('productName').innerHTML = `<span style="color: #db4646;">SynaPad</span> <span style="color:#272327;">Core</span>`;
  } else if (product.name === "SynaPad Plus") {
      document.getElementById('productName').innerHTML = `<span style="color: #db4646;">SynaPad</span> <span style="color:#1a2263;">Plus</span>`;
  } else if (product.name === "SynaPad Pro") {
      document.getElementById('productName').innerHTML = `<span style="color: #db4646;">SynaPad</span> <span style="color:#612525;">Pro</span>`;
  }
